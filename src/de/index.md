    ...
    sections:
      - title: Conshelv unterstützt beim Ordnen Ihrer Fotos
        ...
        paragraphs: 
         ...
         - "Kein Wunder: Wenn man alle Tage ein paar Bilder macht, wird das Verwalten sehr aufwändig!"
         - Conshelv begleitet die Reise Ihrer Bilder vom Zeitpunkt der Aufnahme an und fügt sie automatisch in Ihre Sammlung ein. Dabei werden relevante Eigenschaften automatisch extrahiert. 
         - Ein Durcheinander wird vermieden, indem Sie selbst bestimmen, welche Eigenschaften Ihnen wichtig sind. Sie können beispielsweise nach Ereignissen und Orten suchen oder eine individuelle Sortierung vornehmen. 
         - Sie entscheiden selbst, welche Kriterien wichtig sind. So können Sie kinderleicht danach sortieren und filtern. 
      ...
      - title: Conshelv speichert Bilder lokal auf Ihrem Gerät
        ...
        paragraphs: 
         - Möchten Sie persönliche Fotos den Servern datenhungriger Cloud Anbieter anvertrauen?
         ...
         - Durch die Integration von Conshelv in Ihr eigenes Netzwerk, bekommen Sie automatisch den gewohnten Datenschutz, ohne auf die Vorteile einer herkömmlichen Cloud verzichten zu müssen!
    cta:
      text: "Jetzt ausprobieren"
      desc: "Unverbindlich und kostenlos Anmelden"
      href: "https://d472b0d2.sibforms.com/serve/MUIEABD-K7xsEewUxYV94JqQ6ydStzikCxgPVa2uR_VQ4bJY07_HBzanp1OEsXT8n7nTLLyNUFeMcD4mgoloxaRw_qOAtASUETOF7pwKiduaeS9VRlJDRIo1CGbZNNfmahAfJMG6QhBZiCRgHUUtTKmHDcnX9UcGwkSneZXple9vb_EzkkbSuNE0qIQkaQFAqdj7-tV4V4k9AjZ0"
      id: cta
    contact:
